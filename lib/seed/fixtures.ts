...
export const DEALS: DealFixture[] = [
  {
    ...
    purchasePrice: 16_500_000, appraisedValue: 16_700_000, requestedFinancing: 10_500_000,
  ...
  },
  {
    ...
    purchasePrice: null, appraisedValue: 13_500_000, requestedFinancing: 8_100_000,
  ...
  },
  {
    ...
    purchasePrice: 11_400_000, appraisedValue: 11_600_000, requestedFinancing: 6_600_000,
  ...
  },
  {
    ...
    purchasePrice: null, appraisedValue: 24_000_000, requestedFinancing: 13_900_000,
  ...
  },
  {
    ...
    assetType: 'alf',
    transactionType: 'acquisition',
    city: 'Madison', state: 'WI', zip: '53711', county: 'Dane',
    licensedBeds: 88, certifiedBeds: 88, operatingBeds: 88, currentCensus: 81,
    yearBuilt: 2008, lastRenovation: 2022, cmsStars: null,
    operatingCompany: 'Silver Birch Living LLC', managementCompany: null, realEstateIncluded: true,
    purchasePrice: 36_500_000, appraisedValue: 37_000_000, requestedFinancing: 22_600_000,
    existingDebt: null, sellerFinancing: null, closingCosts: 1_095_000,
    capexRequirement: 400_000, workingCapital: 350_000,
    requestedRatePct: 6.85, requestedTermMonths: 84, requestedAmortMonths: 360, requestedIoMonths: 12,
    targetCloseInDays: 85,
    payer: { medicare: 0, medicaid: 9, managedCare: 4, privatePay: 85, other: 2 },
    periods: history(
      { revenue: 9_400_000, ebitdaMargin: 0.271, beds: 88, occupancy: 92.1 },
      { revenueGrowth: [0.912, 0.951, 1], marginDelta: [-0.021, -0.008, 0], agency: [0.043, 0.028, 0.016], occupancy: [88.4, 90.2, 92.1] },
    ),
    narrative:
      'Private-pay assisted living in a university town with almost no Medicaid exposure. Occupancy has climbed for three straight years and the building was substantially renovated in 2022.',
    status: 'ready',
  },
  {
    slug: 'cardinal-point',
    borrower: 'meridian',
    name: 'Cardinal Point Memory Care',
    assetType: 'memory_care',
    transactionType: 'acquisition',
    city: 'Overland Park', state: 'KS', zip: '66213', county: 'Johnson',
    licensedBeds: 64, certifiedBeds: 64, operatingBeds: 64, currentCensus: 57,
    yearBuilt: 2015, lastRenovation: null, cmsStars: null,
    operatingCompany: 'Cardinal Point Care LLC', managementCompany: 'Northstar Care Management', realEstateIncluded: true,
    purchasePrice: 22_400_000, appraisedValue: 22_200_000, requestedFinancing: 14_100_000,
    existingDebt: null, sellerFinancing: 600_000, closingCosts: 672_000,
    capexRequirement: 250_000, workingCapital: 300_000,
    requestedRatePct: 7.1, requestedTermMonths: 60, requestedAmortMonths: 300, requestedIoMonths: 18,
    targetCloseInDays: 100,
    payer: { medicare: 0, medicaid: 14, managedCare: 3, privatePay: 81, other: 2 },
    periods: history(
      { revenue: 7_100_000, ebitdaMargin: 0.243, beds: 64, occupancy: 89.1 },
      { revenueGrowth: [0.897, 0.944, 1], marginDelta: [-0.026, -0.011, 0], agency: [0.071, 0.052, 0.034], occupancy: [83.6, 86.9, 89.1] },
    ),
    narrative:
      'Purpose-built memory care asset ten years old, in one of the strongest demographic submarkets in the Midwest. The appraisal came in marginally below the contract price.',
    status: 'ready',
  },
  {
    slug: 'harmony-house',
    borrower: 'auburn',
    name: 'Harmony House Behavioral Health',
    assetType: 'behavioral_health',
    transactionType: 'acquisition_refinance',
    city: 'Chattanooga', state: 'TN', zip: '37411', county: 'Hamilton',
    licensedBeds: 72, certifiedBeds: 72, operatingBeds: 68, currentCensus: 59,
    yearBuilt: 2001, lastRenovation: 2019, cmsStars: null,
    operatingCompany: 'Harmony House Health LLC', managementCompany: null, realEstateIncluded: true,
    purchasePrice: 17_000_000, appraisedValue: 17_400_000, requestedFinancing: 11_900_000,
    existingDebt: 2_400_000, sellerFinancing: null, closingCosts: 510_000,
    capexRequirement: 600_000, workingCapital: 400_000,
    requestedRatePct: 7.6, requestedTermMonths: 60, requestedAmortMonths: 300, requestedIoMonths: 12,
    targetCloseInDays: 90,
    payer: { medicare: 12, medicaid: 38, managedCare: 41, privatePay: 7, other: 2 },
    periods: history(
      { revenue: 11_900_000, ebitdaMargin: 0.148, beds: 68, occupancy: 86.8 },
      { revenueGrowth: [0.924, 0.958, 1], marginDelta: [-0.017, -0.006, 0], agency: [0.126, 0.094, 0.062], occupancy: [81.9, 84.7, 86.8] },
    ),
    narrative:
      'Inpatient behavioural health with an unusually high managed-care share, which shortens collection cycles but concentrates the risk in a handful of payer contracts.',
    status: 'ready',
  },
  {
    slug: 'oakmont-village',
    borrower: 'bluestem',
    name: 'Oakmont Village Senior Living',
    assetType: 'alf',
    transactionType: 'refinance',
    city: 'Boise', state: 'ID', zip: '83704', county: 'Ada',
    licensedBeds: 110, certifiedBeds: 110, operatingBeds: 104, currentCensus: 92,
    yearBuilt: 1998, lastRenovation: 2016, cmsStars: null,
    operatingCompany: 'Oakmont Village Operations LLC', managementCompany: null, realEstateIncluded: true,
    purchasePrice: null, appraisedValue: 38_000_000, requestedFinancing: 24_700_000,
    existingDebt: 22_000_000, sellerFinancing: null, closingCosts: 741_000,
    capexRequirement: 1_100_000, workingCapital: null,
    requestedRatePct: 6.7, requestedTermMonths: 84, requestedAmortMonths: 360, requestedIoMonths: 0,
    targetCloseInDays: 120,
    payer: { medicare: 0, medicaid: 22, managedCare: 6, privatePay: 70, other: 2 },
    periods: history(
      { revenue: 12_600_000, ebitdaMargin: 0.216, beds: 104, occupancy: 88.5 },
      { revenueGrowth: [0.948, 0.974, 1], marginDelta: [-0.013, -0.005, 0], agency: [0.052, 0.039, 0.027], occupancy: [85.1, 87.0, 88.5] },
    ),
    narrative:
      'Refinance of a maturing loan on a stabilised private-pay community the sponsor has held for eleven years. A $1.1M capital programme is planned for the common areas.',
    status: 'ready',
  },
  {
    slug: 'lantern-ridge',
    borrower: 'auburn',
    name: 'Lantern Ridge Care Center',
    assetType: 'snf',
    transactionType: 'acquisition',
    city: 'Tulsa', state: 'OK', zip: '74136', county: 'Tulsa',
    licensedBeds: 118, certifiedBeds: 118, operatingBeds: 112, currentCensus: 91,
    yearBuilt: 1985, lastRenovation: 2013, cmsStars: 2,
    operatingCompany: 'Lantern Ridge Operations LLC', managementCompany: 'Northstar Care Management', realEstateIncluded: true,
    purchasePrice: 8_600_000, appraisedValue: 8_200_000, requestedFinancing: 5_400_000,
    existingDebt: null, sellerFinancing: 500_000, closingCosts: 258_000,
    capexRequirement: 1_400_000, workingCapital: 500_000,
    requestedRatePct: 8.1, requestedTermMonths: 48, requestedAmortMonths: 300, requestedIoMonths: 24,
    targetCloseInDays: 80,
    payer: { medicare: 13, medicaid: 68, managedCare: 11, privatePay: 6, other: 2 },
    periods: history(
      { revenue: 15_800_000, ebitdaMargin: 0.061, beds: 112, occupancy: 81.3 },
      { revenueGrowth: [0.961, 0.982, 1], marginDelta: [0.002, -0.001, 0], agency: [0.164, 0.149, 0.131], occupancy: [79.4, 80.6, 81.3] },
    ),
    narrative:
      'A turnaround: two-star rating, heavy Medicaid, persistent agency reliance and an appraisal $500K below the contract price. The sponsor is buying it on that basis and has budgeted accordingly.',
    taxReturnRevenueOverride: 15_240_000,
    status: 'ready',
  },
  {
    slug: 'foxglove',
    ...
    assetType: 'memory_care',
    transactionType: 'acquisition',
    city: 'Grand Rapids', state: 'MI', zip: '49546', county: 'Kent',
    licensedBeds: 56, certifiedBeds: 56, operatingBeds: 56, currentCensus: 48,
    yearBuilt: 2012, lastRenovation: 2021, cmsStars: null,
    operatingCompany: 'Foxglove Court LLC', managementCompany: null, realEstateIncluded: true,
    purchasePrice: 18_400_000, appraisedValue: 18_700_000, requestedFinancing: 11_400_000,
    existingDebt: null, sellerFinancing: 350_000, closingCosts: 552_000,
    capexRequirement: 180_000, workingCapital: 220_000,
    requestedRatePct: 7.0, requestedTermMonths: 60, requestedAmortMonths: 300, requestedIoMonths: 12,
    targetCloseInDays: 95,
    payer: { medicare: 0, medicaid: 11, managedCare: 2, privatePay: 85, other: 2 },
    periods: history(
      { revenue: 6_200_000, ebitdaMargin: 0.229, beds: 56, occupancy: 85.7 },
      { revenueGrowth: [0.906, 0.949, 1], marginDelta: [-0.024, -0.009, 0], agency: [0.058, 0.041, 0.029], occupancy: [80.2, 83.4, 85.7] },
    ),
    narrative:
      'A small, well-run memory care community with the highest private-pay share in the portfolio. The size limits the raise but also the risk: no single payer decision moves it.',
    status: 'ready',
  },
]
